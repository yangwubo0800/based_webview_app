package com.example.ezrealplayer.ui;
...
import com.example.ezrealplayer.util.VerifyCodeInput;
import com.example.ezrealplayer.R;
//import com.base.app.EBApplication;
import com.example.ezrealplayer.util.AudioPlayUtil;
import com.example.ezrealplayer.util.DataManager;
import com.example.ezrealplayer.util.EZUtils;
import com.example.ezrealplayer.util.ScreenOrientationHelper;
import com.example.ezrealplayer.util.WaitDialog;
    ...
    private void ptzOption(final EZPTZCommand command, final EZPTZAction action) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ptz_result = EZUtils.getOpenSDK().controlPTZ(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), command,
            ...
            Thread thr = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        EZUtils.getOpenSDK().setVideoLevel(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), mode.getVideoLevel());
...
//        mTalkPopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
    ...
    private void startRealPlay() {
        ...
        if (mCameraInfo != null) {
            if (mEZPlayer == null) {
                mEZPlayer = EZUtils.getOpenSDK().createPlayer(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo());
            }
            ...
            mEZPlayer = EZUtils.getOpenSDK().createPlayerWithUrl(mRtspUrl);
